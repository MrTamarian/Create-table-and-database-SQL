CREATE DATABASE WW1_DW			 -- Här skapar vi vår databas i ett default läge då den är en så pass liten databas.
								 -- Autogrowth på 64 MB räcker gott och väl och unlimited maxsize är framtidssäkert.									
